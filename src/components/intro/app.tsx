...
export const Intro = () => {
    ...
    return (
        <section id="home" ref={ref} className="mb-28 max-w-[80rem] px-4 text-center sm:mb-0 scroll-mt-[100rem]">
            ...
            >
                <span className="font-medium sm:text-3xl text-2xl">Hello, I&apos;m </span>
                <p className="font-bold text-4xl sm:text-5xl py-6">Pavithra Muthumanickam</p>
                <span className="font-medium text-2xl">A Creative </span>
                <p className="pt-6 font-bold italic text-3xl sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-600">Lead Frontend Developer</p>
