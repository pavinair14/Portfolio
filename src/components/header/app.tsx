...
export const Header = () => {
    ...
    return (
        <header className="z-[999] relative">
            <motion.div
                className="fixed top-0 left-1/2 -translate-x-1/2 bg-white w-[24rem] h-[5rem] rounded-none border border-white border-opacity-40 bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[4rem] sm:w-[45rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
